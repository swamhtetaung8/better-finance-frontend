...
const TopNavBar = () => {
  ...
  return (
    <nav className='grid grid-cols-4 items-center gap-x-4 mb-8'>
      <h1 className='capitalize scroll-m-20 text-2xl xl:text-3xl font-semibold tracking-tight text-betterFinance-primary dark:text-betterFinance-background'>{currentPage}</h1>
      <div></div>
